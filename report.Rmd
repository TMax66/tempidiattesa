---
title: "Definizione e analisi dei tempi di attesa dell'utenza dell'IZSLER"
output: html_notebook
---

# Definizione dei tempi di attesa dell'utenza

Di seguito uno schema che riassume le fasi del processo a cui sottostanno i conferimenti di campioni sottoposti ad analisi per le diverse motivazioni/finalità in tutto l'IZSLER:
...
In entrambi gli scenari è possibile identificare il tempo di circolazione interno o tempo organizzativo del conferimento rappresentato dall'intervallo t3-t2. 
...
t3-t2b: tempo di attesa del campione tra la presa in carico e l'inizio delle analisi. 


Il tempo di allestimento è totalmente responsabilità della struttura accettante che invia i campioni che ha quindi gli strumenti e le opportunità per gestire, controllare, migliorare questo tempo.
...
Infine ultimo tempo è rappresentato dalla data di emissione del primo rapporto di prova firmato (t5). Questo tempo rappresenta il primo feedback che l'utenza ottiene dal momento che ha consegnato i campioni al laboratorio IZSLER. Si fa riferimento qui solo ai conferimenti completi e non parziali, ai fini della definizione del tempo di attesa dell'utenza. 
...
Le analisi dei tempi di attesa dell'utenza saranno quindi eseguite per ogni categoria, in modo da rendere omogenei gli eventuali confronti tra strutture.
